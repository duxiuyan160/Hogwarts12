...
class TestAddAddress:
    ...
    def test_add_address(self, init_driveranddopre, consigneedata):
        ...
        assert HuZhuGouPage.goto_my_add_address(init_driveranddopre).add_address(consignee, consigneephone, consigneeaddress,
